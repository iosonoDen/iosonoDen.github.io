...
export function LinkedInIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M4.98 3.5A2.5 2.5 0 1 1 5 8.5a2.5 2.5 0 0 1-.02-5ZM5 9.75H3v11.5h4V9.75H5Zm7.75 0H9.8v11.5h3.9v-6.05c0-1.6.3-3.15 2.28-3.15 1.96 0 1.99 1.83 1.99 3.25v5.95H22v-6.64c0-3.26-.7-5.76-4.5-5.76-1.83 0-3.05.98-3.55 1.9h-.05V9.75Z" />
    </svg>
  );
}
